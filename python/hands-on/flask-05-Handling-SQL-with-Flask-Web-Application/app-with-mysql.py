...
app.config['MYSQL_DATABASE_HOST'] = 'ozi-db.crxhtimzckdn.us-east-1.rds.amazonaws.com'
...
VALUES 
    ("Stevie", "steive@amazon.com"),
    ("Tugba", "tugba@google.com"),
    ("Murat", "murat@bmw.com"),
    ("Zeynep", "zeynep@mercedes.com"),
