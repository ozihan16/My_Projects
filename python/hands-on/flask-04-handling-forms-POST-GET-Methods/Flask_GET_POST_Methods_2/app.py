...
def calculate ():
    if request.method == "POST":
        mynum1 = request.form.get("number1")
        mynum2 = request.form.get("number2")
        return render_template("result.html", var1 = mynum1, var2 = mynum2, result = lcm(int(mynum1), int(mynum2)), developer_name = "Ozih@n")
    else:
        return render_template("result.html", developer_name = "Ozih@n")
