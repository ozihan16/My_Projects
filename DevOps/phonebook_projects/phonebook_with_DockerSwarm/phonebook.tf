...
locals {
  github-repo = "https://github.com/ozihan16/phonebook_with_dockerSwarm.git"
  github-file-url = "https://raw.githubusercontent.com/ozihan16/phonebook_with_dockerSwarm/master/"
}
